						...
						<>
							...
							{author.email && (
								<div className="flex gap-2 line-clamp-1!">
									<a
										className="font-semibold text-xs break-all max-w-full"
							...
							<div className="flex gap-2">
								{author.redes.map((r, idx) => {
									...
									if (
										...
										Icon = XIcon;
										aria = "X";
									} else if (lowerHost.includes("facebook.com")) {
										Icon = FacebookIcon;
										aria = "Facebook";
									} else if (lowerHost.includes("instagram.com")) {
										Icon = InstagramIcon;
										aria = "Instagram";
									} else if (
